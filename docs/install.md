...
wget https://github.com/empyfi/FBC-ChannelSpeedChange/releases/download/v0.3.0/enigma2-plugin-extensions-fbc-channelspeedchange_0.2.7_all.ipk -O /tmp/fbc.ipk
