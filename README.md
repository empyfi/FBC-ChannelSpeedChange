...
```sh
ssh root@<your-box>
wget https://github.com/empyfi/FBC-ChannelSpeedChange/releases/download/v0.6.4/enigma2-plugin-extensions-fbc-channelspeedchange_0.6.4_all.ipk -O /tmp/fbc.ipk
...
v0.6.4 is the current build for long-term testing on the GigaBlue
