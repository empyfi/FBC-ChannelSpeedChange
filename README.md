...
```sh
ssh root@<your-box>
wget https://github.com/empyfi/FBC-ChannelSpeedChange/releases/download/v0.3.6/enigma2-plugin-extensions-fbc-channelspeedchange_0.3.6_all.ipk -O /tmp/fbc.ipk
...
v0.3.6 is the current build for long-term testing on the GigaBlue
